...
export const ABSEN_DEPARTMENT_TO_CONTACT_MAP: Record<string, {
  ...
  "欧洲Live业务一区": { accountant: "方淑苗", email: "sharon6480@absen.com" },
  "欧洲Live业务二区": { accountant: "方淑苗", email: "sharon6480@absen.com" },
  "欧洲ProAV大客户部": { accountant: "方淑苗", email: "sharon6480@absen.com" },
